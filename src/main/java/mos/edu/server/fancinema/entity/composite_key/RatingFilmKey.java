...
@Embeddable
public class RatingFilmKey implements Serializable {
	...
	protected RatingFilmKey() {}

	public RatingFilmKey(int idUser, int idFilm) {
		this.idUser = idUser;
		this.idFilm = idFilm;
	}
	...
	public boolean equals(Object obj) {
		...
		RatingFilmKey ratingKey = (RatingFilmKey) obj;
		if (this.idUser != ratingKey.idUser) return false;
